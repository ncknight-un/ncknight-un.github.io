...
<div class="project-gallery">
  ...
  <div class="gallery-item">
    <h4>Production Cell Floorplan</h4>
    <img src="/images/mainfloorplan1.jpg" alt="Floorplan 1">
  </div>

  <div class="gallery-item">
    <h4>Table Fixture Design</h4>
    <img src="/images/tabletop.jpg" alt="Tabletop">
  </div>

  <div class="gallery-item">
    <h4>End-of-Line Floorplan</h4>
    <img src="/images/end_pipeline.jpeg" alt="End Floorplan 1">
  </div>

  <div class="gallery-item">
    <h4>Orientation Stage</h4>
    <img src="/images/orientation.jpg" alt="Orientation Stage">
  </div>

  <div class="gallery-item">
    <h4>Product Packaging</h4>
    <img src="/images/packaging.jpg" alt="Packaging">
  </div>
  ...
  <div class="gallery-item">
    <h4>Part Cart</h4>
    <img src="/images/part_cart.jpg" alt="Part Cart">
  </div>

  <div class="gallery-item">
    <h4>Mill Fixture Demo</h4>
    <video autoplay loop muted playsinline>
      <source src="/images/Fixture1.mp4" type="video/mp4">
...
<div class="project-gallery">
  ...
  <div class="gallery-item">
    <h4>Production Cell Floorplan</h4>
    <img src="/images/floorplan2_top.jpeg" alt="Floorplan 2">
  </div>

  <div class="gallery-item">
    <h4>Floorplan - Side View</h4>
    <img src="/images/floorplan2_side.jpeg" alt="Floorplan 2 side">
  </div>

  <div class="gallery-item">
    <h4>Mill Fixture Design 1</h4>
    <img src="/images/mill_fixture_p2.1.jpeg" alt="Mill D1">
  </div>

  <div class="gallery-item">
    <h4>Mill Fixture Design 2</h4>
    <img src="/images/mill_fixture_p2.2.jpeg" alt="Mill D2">
  </div>

  <div class="gallery-item">
    <h4>Lathe Fixture Design - Top View</h4>
    <img src="/images/lathe_fixture2.jpeg" alt="Lathe D1">
  </div>

  <div class="gallery-item">
    <h4>Lathe Fixture Design - Side View</h4>
    <img src="/images/lathe_fixture1.jpeg" alt="Lathe D2">
  </div>

  <div class="gallery-item">
    <h4>Pallete Loader #1</h4>
    <img src="/images/pallete_loader_p2.1.jpeg" alt="Pallete L1">
  </div>

  <div class="gallery-item">
    <h4>Pallete Loader #2</h4>
    <img src="/images/pallete_loader_p2.2.jpeg" alt="Pallete L2">
  </div>
</div>
